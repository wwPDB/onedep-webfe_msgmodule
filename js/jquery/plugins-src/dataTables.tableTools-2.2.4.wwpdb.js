 ...
 */
/**
 * 2015-04-30, RPS: _fnPrintHideNodes modified to keep scrollHead visible for "Print" view
 * 2015-08-19, RPS: _fnPrintStart and _fnPrintEnd modified to accommodate visibility of entire table with 
 * 					#rslts_resize_container integrated.
 */
...
TableTools.prototype = {
	...
	"_fnPrintStart": function ( oConfig )
	{
	  ...
	  var oSetDT = this.s.dt;
	  	...
	  	//2015-08-19, RPS: below two lines added to accommodate visibility of entire table with #rslts_resize_container integrated.
	  	MsgingMod.iRsltsResizeContainerHtPrePrint_CommHstry = $("#rslts_resize_container").height();
	...
	"_fnPrintEnd": function ( e )
	{
		...
		$(document).unbind( "keydown.DTTT" );
	  	...
	  	//2015-08-19, RPS: below line added to accommodate visibility of entire table with #rslts_resize_container integrated.
		$("#rslts_resize_container").height(MsgingMod.iRsltsResizeContainerHtPrePrint_CommHstry);
	},
		...
		for ( var i=0, iLen=nChildren.length ; i<iLen ; i++ )
		{
			if ( nChildren[i] != nNode && nChildren[i].nodeType == 1 )
			{
				...
				if ( sDisplay != "none" )
				{
					...
					// 2015-04-30, RPS: for wwPDB purposes leaving scrollHead visible for printing
					if( ! $(nChildren[i]).hasClass("dataTables_scrollHead") ){
