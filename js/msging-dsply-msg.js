...
$(document).ready(function() {
    ...
    $.ajax({
        url: '/msgmodule/js/jquery/ui/jquery-ui.custom.min.js',
        async: false,
        dataType: 'script'
    });
    $.ajax({
        url: '/js/jquery/plugins/jquery.form.min.js',
        async: false,
        dataType: 'script'
    });
    $.ajax({
        url: '/msgmodule/js/jquery/plugins-src/jquery.bt-0.9.7.wwpdb.min.js',
        async: false,
        dataType: 'script'
    });
    $.ajax({
        url: '/msgmodule/js/depui.js',
        async: false,
        dataType: 'script'
    }); //evenutally needed for Annot-to-DepUI "RESET" comm
    $.ajax({
        url: '/msgmodule/js/wfm.js',
        async: false,
        dataType: 'script'
    }); //evenutally needed for Annot-to-DepUI "RESET" comm
    $.ajax({
        url: '/msgmodule/js/jquery/plugins-src/spin.js',
        async: false,
        dataType: 'script'
    });
    $.ajax({
        url: '/msgmodule/js/jquery/plugins-src/jquery.spin.js',
        async: false,
        dataType: 'script'
    });
